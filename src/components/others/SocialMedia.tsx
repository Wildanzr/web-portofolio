...
export default function SocialMedia () {
  return (
    <div className="w-full lg:w-8/12 flex flex-col items-start justify-center space-y-10">
      <div className="w-full flex flex-col">
        <p className="text-4xl font-bold tracking-wider text-pink-400 dark:text-blue-400 duration-500 ease-in-out">
          Get in touch
        </p>
